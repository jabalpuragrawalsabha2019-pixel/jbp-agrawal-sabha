...
const TrainAnimation = ({ announcements = [] }) => {
  ...
  useEffect(() => {
    ...
    const totalWidth =
      SCREEN_WIDTH + announcements.length * (COACH_WIDTH + COACH_SPACING) + 20;
  ...
  return (
    <View style={styles.container}>
      <Animated.View
        style={[styles.trainContainer, { transform: [{ translateX }] }]}
      >
              ...
              <View style={styles.coachBody}>
                ...
                <View style={styles.contentRow}>
                  <View style={styles.iconBadge}>
                    <Ionicons
                      name={
                        announcement.is_event ? "star" : "megaphone-outline"
                      }
                      size={16}
                      color="#FFD700"
                    />
